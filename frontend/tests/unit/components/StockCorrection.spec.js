...
describe('StockCorrection.vue', () => {
    ...
    it('displays an alert if SKU or adjustment is missing', async () => {
        ...
        expect(window.alert).toHaveBeenCalledWith('Please fill in both SKU Code and Stock Adjustment.');
    });
    ...
    it('makes a correct API call on form submission', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('https://com.servhub.fr/api/products/SKU123');
    ...
    it('displays an alert on API fetch failure', async () => {
        ...
        expect(window.alert).toHaveBeenCalledWith('Error fetching product with SKU: SKU123');
    });
